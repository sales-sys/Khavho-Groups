...
function loadProducts(filter = 'all') {
    ...
    try {
        ...
        // Get products from shared system
        if (typeof window.getSharedProducts === 'function') {
            products = getSharedProducts();
        } else {
            console.log('getSharedProducts not available in loadProducts');
            products = [];
        }
                ...
                <div class="product-card" data-category="${product.category}">
                    ...
                    <div class="product-content">
                        ...
                        <div class="product-footer">
                            <div class="product-price">R${product.price ? product.price.toLocaleString() : 'Quote'}</div>
                            <button class="add-to-cart ${isAvailable ? 'available' : 'unavailable'}" 
                                    onclick="${isAvailable ? `addToCart(${product.id})` : 'return false;'}" 
        ...
        productsGrid.innerHTML = '<div class="error-products">Error loading products. Please try again.</div>';
    }
}
